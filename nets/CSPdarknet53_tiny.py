...
class Resblock_body(nn.Module):
    ...
    def forward(self, x):
        ...
        #----------------------------------------------------------------#
        # 对特征层的通道进行均等分割，第一部分不要，取第二部分作为主干部分。
        #----------------------------------------------------------------#
        ...
        #---------------------------------------------------#
        #   x:    CPSLayer最后拼接进行池化  h/2, w/2, 2out_channels
        #   feat: 主干残差部分的输出         h,   w,   out_channels
        #---------------------------------------------------#
        return x, feat
...
class CSPDarkNet(nn.Module):
    ...
    def forward(self, x):
        ...
        #---------------------------------------------------#
        #   x:    CPSLayer最后拼接进行池化  h/2, w/2, 2out_channels
        #   feat1:主干残差部分的输出         h,   w,   out_channels
        #   26,26,256 -> x为    13,13,512
        #             -> feat1为26,26,256
        #---------------------------------------------------#
